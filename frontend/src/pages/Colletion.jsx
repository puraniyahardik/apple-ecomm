    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className=" min-w-60">
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className=" flex flex-col gap-2 text-sm font-light text-gray-700 ">
            <p className=" flex gap-2">
              <input type="checkbox" className='w-3' onChange={SubtoggleCategory} value={'Topwear'}/> Topwear
            </p>
            <p className=" flex gap-2">
              <input type="checkbox" className='w-3' onChange={SubtoggleCategory}  value={'Bottomwear'}/> Bottomwear
            </p>
            <p className=" flex gap-2">
              <input type="checkbox" className='w-3' onChange={SubtoggleCategory}  value={'Winterwear'}/> Winterwear
            </p>
          </div>
        </div>
      </div>
