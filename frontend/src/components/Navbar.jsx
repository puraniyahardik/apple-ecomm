    ...
    <div className='flex items-center justify-between py-5 font-medium '>
       <Link to='/'><img src={assets.logo} className='w-36' alt="Logo" /></Link> 
        ...
        <div className='flex items-center gap-6'>
            <img src={assets.search_icon} alt="search Icon" onClick={()=>setShowSearch(true)} className='w-5 cursor-pointer' />
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all duration-300 delay-100 ${visible ? 'w-full' : 'w-0'}`}>
